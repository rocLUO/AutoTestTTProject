...
import static config.WebInfo.waitTime;
...
public class AppBase extends AppInfo{
    ...
    public static void clickXpath(String Xpath, AppiumDriver Driver) {
        ...
        } catch (Error e) {         /*NotFoundException 检查未查找元素报错信息,默认Error*/
    ...
    public static void inPutById(String Id, String Text, AppiumDriver Driver) {
        ...
        } catch (NotFoundException | Error e) {
    ...
    public static void testNgCheckXpath(AppiumDriver Driver, String Xpath) throws InterruptedException {
